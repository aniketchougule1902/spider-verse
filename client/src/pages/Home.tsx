        ...
        <main id="top" className="experience-shell">
          ...
          <section id="home" className="hero-section">
            ...
            <div className="observatory-assembly" aria-hidden="true">
              ...
              <div className="hero-astronomy" aria-hidden="true">
                <div className="deep-planet deep-planet-cobalt"><i /></div>
                <div className="deep-planet deep-planet-ember"><i /></div>
                <div className="comet-trace"><i /></div>
                <div className="star-cluster"><i /><i /><i /><i /><i /></div>
                <div className="orbit-scan orbit-scan-one" />
                <div className="orbit-scan orbit-scan-two" />
                <span className="celestial-label celestial-label-one">CYGNUS // 0.003 LY</span>
                <span className="celestial-label celestial-label-two">ORBITAL DUST // ACTIVE</span>
              </div>
              <style>{`
                .hero-astronomy{position:absolute;inset:0;z-index:1;pointer-events:none}.deep-planet{position:absolute;overflow:hidden;border-radius:50%;box-shadow:inset -13px -12px 18px rgba(0,0,0,.8),inset 8px 6px 12px rgba(255,255,255,.24),0 0 24px rgba(104,170,255,.22);animation:deep-planet-drift 13s ease-in-out infinite}.deep-planet::after{content:"";position:absolute;inset:-18%;border:1px solid rgba(155,202,255,.32);border-radius:50%;transform:rotate(-28deg)}.deep-planet i{position:absolute;inset:28% -20% auto -12%;height:12%;background:rgba(238,252,255,.28);transform:rotate(-18deg);filter:blur(2px)}.deep-planet-cobalt{top:10%;right:42%;width:clamp(40px,4.1vw,68px);height:clamp(40px,4.1vw,68px);background:radial-gradient(circle at 32% 28%,#c9f7ff 0 4%,#3d9bd4 16%,#173767 54%,#071124 75%)}.deep-planet-ember{right:4%;bottom:32%;width:clamp(24px,2.8vw,44px);height:clamp(24px,2.8vw,44px);background:radial-gradient(circle at 28% 25%,#ffc36a 0 4%,#ca5939 18%,#682139 55%,#18091c 76%);animation-delay:-7s}.comet-trace{position:absolute;top:27%;right:15%;width:clamp(72px,8vw,132px);height:2px;transform:rotate(-25deg);background:linear-gradient(90deg,transparent,rgba(174,223,255,.18),rgba(243,252,255,.92));filter:drop-shadow(0 0 7px rgba(149,212,255,.8));animation:comet-pass 8s cubic-bezier(.25,.8,.35,1) infinite}.comet-trace i{position:absolute;right:-3px;top:50%;width:6px;height:6px;border-radius:50%;background:#f6ffff;transform:translateY(-50%);box-shadow:0 0 10px 3px rgba(178,229,255,.85)}.star-cluster{position:absolute;right:30%;bottom:12%;width:110px;height:80px;opacity:.9;animation:cluster-shimmer 5s ease-in-out infinite}.star-cluster i{position:absolute;width:3px;height:3px;border-radius:50%;background:#eaf6ff;box-shadow:0 0 7px 2px rgba(177,221,255,.65)}.star-cluster i:nth-child(1){top:7%;left:8%}.star-cluster i:nth-child(2){top:34%;left:44%;width:5px;height:5px}.star-cluster i:nth-child(3){top:16%;right:5%}.star-cluster i:nth-child(4){bottom:10%;left:25%;width:4px;height:4px}.star-cluster i:nth-child(5){bottom:30%;right:22%}.orbit-scan{position:absolute;border:1px solid rgba(180,218,255,.24);border-left-color:transparent;border-radius:50%;animation:orbit-scan-spin 18s linear infinite}.orbit-scan-one{top:4%;right:8%;width:clamp(150px,18vw,260px);height:clamp(55px,6vw,86px);transform:rotate(23deg)}.orbit-scan-two{right:18%;bottom:18%;width:clamp(130px,15vw,210px);height:clamp(42px,5vw,66px);transform:rotate(-18deg);animation-direction:reverse;animation-duration:22s}.celestial-label{position:absolute;color:rgba(211,229,252,.68);font:600 7px/1.35 Space Grotesk,sans-serif;letter-spacing:.16em;white-space:nowrap}.celestial-label-one{right:42%;top:8%;transform:rotate(-7deg)}.celestial-label-two{right:8%;bottom:26%;transform:rotate(5deg)}@keyframes deep-planet-drift{0%,100%{transform:translate3d(0,0,0) rotate(0deg)}50%{transform:translate3d(0,-9px,0) rotate(12deg)}}@keyframes comet-pass{0%,23%,100%{opacity:0;transform:translate3d(38px,-18px,0) rotate(-25deg)}35%,66%{opacity:1}78%{opacity:0;transform:translate3d(-22px,14px,0) rotate(-25deg)}}@keyframes cluster-shimmer{0%,100%{opacity:.45;transform:scale(.96)}50%{opacity:1;transform:scale(1)}}@keyframes orbit-scan-spin{to{rotate:1turn}}@media (max-width:860px){.deep-planet-cobalt{right:29%;top:15%;width:38px;height:38px}.deep-planet-ember,.celestial-label-two,.orbit-scan-two{display:none}.comet-trace{right:6%;top:31%;width:74px}.star-cluster{right:18%;bottom:25%;transform:scale(.72);transform-origin:center}.orbit-scan-one{right:-1%;top:8%;width:145px;height:48px}.celestial-label-one{right:29%;top:12%;font-size:6px}}@media (prefers-reduced-motion:reduce){.deep-planet,.comet-trace,.star-cluster,.orbit-scan{animation:none!important}.comet-trace{opacity:.55}}
              `}</style>
